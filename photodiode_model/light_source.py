"""Class to define the Light Source component."""
...
class LightSource():
    ...
    Attributes:
        power (float):  Power of the Light Source (in W).
        luminous_flux (float): Luminous flux of the Light Source (in lm).
        __characteristics (list): Characteristics curves from the datasheet.
    """
    def __init__(self, power : float,  luminous_flux : float):
        """
